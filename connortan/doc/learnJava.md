...
![](images/../../../java1/doc/images/LanguageBasics.svg)
...
* Object Oriented Programming concept
  ![](images/../../images/oop.png)
* Encapsulation: private, protected
* Abstraction: abstract object in the real world to write a class.
  ![](images/../../images/ClassAbstraction.png)

  [First class](../../java1/src/com/huaxia/java1/Air.java)
  ...
  3. Inheritance: subclass inherits features from super class.
   ...
   where the Student class is subclass of Person class, we call the Person as Superclass of Stident class.

  * [Superclass](../src/com/../../../java1/bin/com/huaxia/java1/Person.class)
  * [Student, Subclass Of Person](../src/com/../../../java1/bin/com/huaxia/java1/Student.class)
  * [Teacher, Subclass of Person](..src/com/../../../../java1/src/com/huaxia/java1/Teacher.java)
  
  4. Polymorphism: give different answer for the same question from different class. (异类同功)

  [Test Polymorphism](../../java1/src/com/huaxia/test/TestMethod.java)
